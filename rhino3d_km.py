...
[("View2D",
 ...
 ("Image Paint",
  ...
  {"items":
   [("paint.image_paint",
    ...
    ("paint.grab_clone", {"type": 'RIGHTMOUSE', "value": 'PRESS', "alt": True}, None),
 ...
 ("3D View",
  ...
  {"items":
   [("view3d.cursor3d", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True, "alt": True}, None),
    ...
    ("wm.search_menu", {"type": 'MIDDLEMOUSE', "value": 'PRESS'}, None),
    ],
   },
  ),
 ("3D View Tool: Edit Mesh, Add Cube",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("view3d.cursor3d", {"type": 'LEFTMOUSE', "value": 'CLICK', "shift": True, "ctrl": True, "alt": True}, None),
  ...
  {"items":
   [("anim.channels_click", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ...
    ("wm.call_menu",
     {"type": 'RIGHTMOUSE', "value": 'PRESS'},
     {"properties":
      [("name", 'DOPESHEET_MT_specials_channels'),
       ],
      },
     ),
    ],
